...
require "default.yazi"				-- yazi (file explorer written in rust)
require "default.oil"				-- oil (file explorer)
...
require "default.indentline"		-- Show Vertical line corresponding to the various level of indentation. NB. Hai commentato la linea 22 del file utils.lua del plugin (Il file è nella cartella del plugin dentro la cartella packer)
